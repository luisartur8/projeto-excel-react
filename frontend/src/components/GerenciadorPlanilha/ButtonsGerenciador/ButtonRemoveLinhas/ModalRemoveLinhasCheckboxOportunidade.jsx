 ...
 * @component
 * 
 * Componente respectivo a planilhas do tipo Oportunidade.
 * 
 ...
 * @param {Function} setCbBonusValor
 * @param {Function} setCbBonusValidade
 * 
 * @returns {JSX.Element} - Retorna uma tabela com as checkboxes
 */
function ModalRemoveLinhasCheckboxOportunidade({
    cbNome, setCbNome,
...
ModalRemoveLinhasCheckboxOportunidade.propTypes = {
    ...
    setCbBonusValor: PropTypes.func.isRequired,
    cbBonusValidade: PropTypes.bool.isRequired,
    setCbBonusValidade: PropTypes.func.isRequired,
}

export default ModalRemoveLinhasCheckboxOportunidade;