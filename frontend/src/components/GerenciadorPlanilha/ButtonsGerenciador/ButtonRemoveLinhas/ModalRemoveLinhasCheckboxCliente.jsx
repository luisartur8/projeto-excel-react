 ...
 * @component
 * 
 * Componente respectivo a planilhas do tipo Cliente.
 * 
 ...
 */
function ModalRemoveLinhasCheckboxCliente({
    cbNome, setCbNome,
...
ModalRemoveLinhasCheckboxCliente.propTypes = {
...
export default ModalRemoveLinhasCheckboxCliente;