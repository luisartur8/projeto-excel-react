...
function ButtonOrdenarAlfabetico({ index, tableData, setTableData }) {
    ...
    return (
        <>
            <button className="btn-ordenar-crescente" onClick={() => ordenarAlfabetico('crescente')}>AZ</button>
            <button className="btn-ordenar-decrescente" onClick={() => ordenarAlfabetico('decrescente')}>ZA</button>
        </>
    )
